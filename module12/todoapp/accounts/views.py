...
#пиздец догадайся что эту строчку надо ставить. 
...
send_mail("Привет от django", "Письмо отправленное из приложения", settings.EMAIL_HOST_USER, ["genusor@gmail.com"], fail_silently=False)